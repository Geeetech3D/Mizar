...
void lv_draw_move_motor(void) {
  ...
  lv_imgbtn_set_src(buttonXI, LV_BTN_STATE_PR, "F:/bmp_clear.bin");
  ...
  lv_obj_clear_protect(buttonXI, LV_PROTECT_FOLLOW);
    ...
    lv_imgbtn_set_src(buttonXD, LV_BTN_STATE_PR, "F:/bmp_clear.bin");
    ...
    lv_imgbtn_set_src(buttonYI, LV_BTN_STATE_PR, "F:/bmp_clear.bin");
    ...
    lv_imgbtn_set_src(buttonYD, LV_BTN_STATE_PR, "F:/bmp_clear.bin");
