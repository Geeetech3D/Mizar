...
void gCfgItems_init() {
  ...
  gCfgItems.pausePosY         = Y_BED_SIZE;
  gCfgItems.pausePosZ         = 0;
  gCfgItems.levelingPos[0][0] = 30;
  gCfgItems.levelingPos[0][1] = 30;
  gCfgItems.levelingPos[1][0] = 30;
  gCfgItems.levelingPos[1][1] = 200;
  gCfgItems.levelingPos[2][0] = 200;
  gCfgItems.levelingPos[2][1] = 200;
  gCfgItems.levelingPos[3][0] = 200;
  gCfgItems.levelingPos[3][1] = 30;
  gCfgItems.levelingPos[4][0] = 115;
  gCfgItems.levelingPos[4][1] = 115;
...
void GUI_RefreshPage() {
  if ((systick_uptime_millis % 1000) == 0){ temperature_change_frequency = 1; return_printui_chk = 1;}
