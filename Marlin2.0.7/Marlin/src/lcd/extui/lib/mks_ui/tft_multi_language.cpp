  ...
  switch (gCfgItems.language) {
    case LANG_SIMPLE_CHINESE:
      ...
      more_menu.title   = TITLE_MORE_CN;
              ...
              more_menu.BLTouch_Reset = MORE_CUSTOM1_TEXT_CN;
            #endif
            #if ENABLED(USER_CMD_2_ENABLE)
              more_menu.BLTouch_Test = MORE_CUSTOM2_TEXT_CN;
            #endif
            #if ENABLED(USER_CMD_3_ENABLE)
              more_menu.BLTouch_Deploy = MORE_CUSTOM3_TEXT_CN;
            #endif
            #if ENABLED(USER_CMD_4_ENABLE)
              more_menu.BLTouch_Stow = MORE_CUSTOM4_TEXT_CN;
            #endif
            #if ENABLED(USER_CMD_5_ENABLE)
              more_menu.BLTouch_Off = MORE_CUSTOM5_TEXT_CN;
			        more_menu.BLTouch_On = MORE_CUSTOM6_TEXT_CN;
            #endif
            #if ENABLED(USER_CMD_6_ENABLE)
              more_menu.BLTouch_Set = MACHINE_PARA_CN;
            #endif
      ...
      break;
          ...
          case LANG_COMPLEX_CHINESE:
            ...
            #if ENABLED(USER_CMD_1_ENABLE)
              more_menu.BLTouch_Reset = MORE_CUSTOM1_TEXT_T_CN;
            #endif
            #if ENABLED(USER_CMD_2_ENABLE)
              more_menu.BLTouch_Test = MORE_CUSTOM2_TEXT_T_CN;
            #endif
            #if ENABLED(USER_CMD_3_ENABLE)
              more_menu.BLTouch_Deploy = MORE_CUSTOM3_TEXT_T_CN;
            #endif
            #if ENABLED(USER_CMD_4_ENABLE)
              more_menu.BLTouch_Stow = MORE_CUSTOM4_TEXT_T_CN;
            #endif
            #if ENABLED(USER_CMD_5_ENABLE)
              more_menu.BLTouch_Off = MORE_CUSTOM5_TEXT_T_CN;
			  more_menu.BLTouch_On = MORE_CUSTOM6_TEXT_T_CN;
            #endif
            #if ENABLED(USER_CMD_6_ENABLE)
              more_menu.BLTouch_Set = MORE_CUSTOM6_TEXT_T_CN;
            #endif
            #if ENABLED(USER_CMD_7_ENABLE)
          ...
          case LANG_ENGLISH:
            ...
            #if ENABLED(USER_CMD_1_ENABLE)
              more_menu.BLTouch_Reset = MORE_CUSTOM1_TEXT_EN;
            #endif
            #if ENABLED(USER_CMD_2_ENABLE)
              more_menu.BLTouch_Test = MORE_CUSTOM2_TEXT_EN;
            #endif
            #if ENABLED(USER_CMD_3_ENABLE)
              more_menu.BLTouch_Deploy = MORE_CUSTOM3_TEXT_EN;
            #endif
            #if ENABLED(USER_CMD_4_ENABLE)
              more_menu.BLTouch_Stow = MORE_CUSTOM4_TEXT_EN;
            #endif
            #if ENABLED(USER_CMD_5_ENABLE)
              more_menu.BLTouch_Off = MORE_CUSTOM5_TEXT_EN;
			  more_menu.BLTouch_On = MORE_CUSTOM6_TEXT_EN;
            #endif
            #if ENABLED(USER_CMD_6_ENABLE)
              more_menu.BLTouch_Set = MORE_CUSTOM6_TEXT_EN;
            #endif
            #if ENABLED(USER_CMD_7_ENABLE)
          ...
          case LANG_RUSSIAN:
            ...
            #if ENABLED(USER_CMD_1_ENABLE)
              more_menu.BLTouch_Reset = MORE_CUSTOM1_TEXT_RU;
            #endif
            #if ENABLED(USER_CMD_2_ENABLE)
              more_menu.BLTouch_Test = MORE_CUSTOM2_TEXT_RU;
            #endif
            #if ENABLED(USER_CMD_3_ENABLE)
              more_menu.BLTouch_Deploy = MORE_CUSTOM3_TEXT_RU;
            #endif
            #if ENABLED(USER_CMD_4_ENABLE)
              more_menu.BLTouch_Stow = MORE_CUSTOM4_TEXT_RU;
            #endif
            #if ENABLED(USER_CMD_5_ENABLE)
              more_menu.BLTouch_Off = MORE_CUSTOM5_TEXT_RU;
			  more_menu.BLTouch_On = MORE_CUSTOM6_TEXT_RU;
            #endif
            #if ENABLED(USER_CMD_6_ENABLE)
              more_menu.BLTouch_Set = MORE_CUSTOM6_TEXT_RU;
            #endif
            #if ENABLED(USER_CMD_7_ENABLE)
          ...
          case LANG_SPANISH:
            ...
            #if ENABLED(USER_CMD_1_ENABLE)
              more_menu.BLTouch_Reset = MORE_CUSTOM1_TEXT_SP;
            #endif
            #if ENABLED(USER_CMD_2_ENABLE)
              more_menu.BLTouch_Test = MORE_CUSTOM2_TEXT_SP;
            #endif
            #if ENABLED(USER_CMD_3_ENABLE)
              more_menu.BLTouch_Deploy = MORE_CUSTOM3_TEXT_SP;
            #endif
            #if ENABLED(USER_CMD_4_ENABLE)
              more_menu.BLTouch_Stow = MORE_CUSTOM4_TEXT_SP;
            #endif
            #if ENABLED(USER_CMD_5_ENABLE)
              more_menu.BLTouch_Off = MORE_CUSTOM5_TEXT_SP;
			  more_menu.BLTouch_On = MORE_CUSTOM6_TEXT_SP;
            #endif
            #if ENABLED(USER_CMD_6_ENABLE)
              more_menu.BLTouch_Set = MORE_CUSTOM6_TEXT_SP;
            #endif
            #if ENABLED(USER_CMD_7_ENABLE)
        ...
        case LANG_FRENCH:
          ...
          more_menu.title       = TITLE_MORE_FR;
            #if ENABLED(USER_CMD_1_ENABLE)
              more_menu.BLTouch_Reset = MORE_CUSTOM1_TEXT_FR;
            #endif
            #if ENABLED(USER_CMD_2_ENABLE)
              more_menu.BLTouch_Test = MORE_CUSTOM2_TEXT_FR;
            #endif
            #if ENABLED(USER_CMD_3_ENABLE)
              more_menu.BLTouch_Deploy = MORE_CUSTOM3_TEXT_FR;
            #endif
            #if ENABLED(USER_CMD_4_ENABLE)
              more_menu.BLTouch_Stow = MORE_CUSTOM4_TEXT_FR;
            #endif
            #if ENABLED(USER_CMD_5_ENABLE)
              more_menu.BLTouch_Off = MORE_CUSTOM5_TEXT_FR;
			  more_menu.BLTouch_On = MORE_CUSTOM6_TEXT_FR;
            #endif
            #if ENABLED(USER_CMD_6_ENABLE)
              more_menu.BLTouch_Set = MORE_CUSTOM6_TEXT_FR;
            #endif
            #if ENABLED(USER_CMD_7_ENABLE)
        ...
        case LANG_ITALY:
          ...
          more_menu.title       = TITLE_MORE_IT;
            #if ENABLED(USER_CMD_1_ENABLE)
              more_menu.BLTouch_Reset = MORE_CUSTOM1_TEXT_IT;
            #endif
            #if ENABLED(USER_CMD_2_ENABLE)
              more_menu.BLTouch_Test = MORE_CUSTOM2_TEXT_IT;
            #endif
            #if ENABLED(USER_CMD_3_ENABLE)
              more_menu.BLTouch_Deploy = MORE_CUSTOM3_TEXT_IT;
            #endif
            #if ENABLED(USER_CMD_4_ENABLE)
              more_menu.BLTouch_Stow = MORE_CUSTOM4_TEXT_IT;
            #endif
            #if ENABLED(USER_CMD_5_ENABLE)
              more_menu.BLTouch_Off = MORE_CUSTOM5_TEXT_IT;
			  more_menu.BLTouch_On = MORE_CUSTOM6_TEXT_IT;
            #endif
            #if ENABLED(USER_CMD_6_ENABLE)
              more_menu.BLTouch_Set = MORE_CUSTOM6_TEXT_IT;
            #endif
            #if ENABLED(USER_CMD_7_ENABLE)
