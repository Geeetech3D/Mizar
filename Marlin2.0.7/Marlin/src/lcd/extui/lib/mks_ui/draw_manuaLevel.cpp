    ...
    case ID_M_POINT1:
      if (event == LV_EVENT_CLICKED) {
        ...
        if (queue.length == 0) {
          ...
          queue.enqueue_now_P(PSTR("G1 Z10 F3000"));
    ...
    case ID_M_POINT2:
      if (event == LV_EVENT_CLICKED) {
        ...
        if (queue.length == 0) {
          ...
          ZERO(public_buf_l);
          sprintf_P(public_buf_l, PSTR("G1 X%d F3000 Y%d F3000"), (int)gCfgItems.levelingPos[1][0], (int)gCfgItems.levelingPos[1][1]);
          queue.enqueue_one_now(public_buf_l);
          queue.enqueue_now_P(PSTR("G1 Z0"));
        }
      }
    ...
    case ID_M_POINT3:
      if (event == LV_EVENT_CLICKED) {
        ...
        if (queue.length == 0) {
          ...
          ZERO(public_buf_l);
          sprintf_P(public_buf_l, PSTR("G1 X%d F3000 Y%d F3000"), (int)gCfgItems.levelingPos[2][0], (int)gCfgItems.levelingPos[2][1]);
          queue.enqueue_one_now(public_buf_l);
          queue.enqueue_now_P(PSTR("G1 Z0"));
        }
      }
    ...
    case ID_M_POINT4:
      if (event == LV_EVENT_CLICKED) {
        ...
        if (queue.length == 0) {
          ...
          ZERO(public_buf_l);
          sprintf_P(public_buf_l, PSTR("G1 X%d F3000 Y%d F3000"), (int)gCfgItems.levelingPos[3][0], (int)gCfgItems.levelingPos[3][1]);
          queue.enqueue_one_now(public_buf_l);
          queue.enqueue_now_P(PSTR("G1 Z0"));
        }
      }
    ...
    case ID_M_POINT5:
      if (event == LV_EVENT_CLICKED) {
        ...
        if (queue.length == 0) {
          ...
          ZERO(public_buf_l);
          sprintf_P(public_buf_l, PSTR("G1 X%d F3000 Y%d F3000"), (int)gCfgItems.levelingPos[4][0], (int)gCfgItems.levelingPos[4][1]);
          queue.enqueue_one_now(public_buf_l);
          queue.enqueue_now_P(PSTR("G1 Z0"));
        }
      }
...
void lv_draw_manualLevel(void) {
  ...
  lv_imgbtn_set_src(buttonPoint1, LV_BTN_STATE_PR, "F:/bmp_clear.bin");
  ...
  lv_obj_clear_protect(buttonPoint1, LV_PROTECT_FOLLOW);
    ...
    lv_imgbtn_set_src(buttonPoint2, LV_BTN_STATE_PR, "F:/bmp_clear.bin");
    ...
    lv_imgbtn_set_src(buttonPoint3, LV_BTN_STATE_PR, "F:/bmp_clear.bin");
    ...
    lv_imgbtn_set_src(buttonPoint4, LV_BTN_STATE_PR, "F:/bmp_clear.bin");
    ...
    lv_imgbtn_set_src(buttonPoint5, LV_BTN_STATE_PR, "F:/bmp_clear.bin");
