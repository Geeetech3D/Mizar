...
void disp_gcode_icon(uint8_t file_num) {
  ...
  lv_imgbtn_set_src(buttonPageUp, LV_BTN_STATE_PR, "F:/bmp_clear.bin");
  ...
  lv_imgbtn_set_style(buttonPageUp, LV_BTN_STATE_REL, &tft_style_label_rel);
    ...
    lv_imgbtn_set_src(buttonPageDown, LV_BTN_STATE_PR, "F:/bmp_clear.bin");
  ...
  lv_obj_set_pos(buttonPageUp, OTHER_BTN_XPIEL * 3 + INTERVAL_V * 7, titleHeight);
  lv_obj_set_pos(buttonPageDown, OTHER_BTN_XPIEL * 3 + INTERVAL_V * 7, titleHeight + OTHER_BTN_YPIEL + INTERVAL_H);
  lv_obj_set_pos(buttonBack, OTHER_BTN_XPIEL * 3 + INTERVAL_V * 7, titleHeight + OTHER_BTN_YPIEL * 2 + INTERVAL_H * 2);
